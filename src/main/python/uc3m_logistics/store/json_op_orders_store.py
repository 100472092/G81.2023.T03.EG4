...
class Json_op_order_store():
    class __Json_op_order_store(Json_op):
        def __init__(self):
    ...
    instance = None
    def __new__(self):
        if not Json_op_order_store.instance:
            Json_op_order_store.instance = Json_op_order_store.__Json_op_order_store()
        return Json_op_order_store.instance
